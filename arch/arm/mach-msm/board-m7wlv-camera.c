...
#if 0	
	if (system_rev == 0 || !m7wlv_use_ext_1v2()) { 
#else
	if (1) {
#endif	
...
static int m7wlv_ov4688_vreg_on(void)
{
	int rc =0;
	pr_info("%s\n", __func__);
...
static int m7wlv_ov4688_vreg_off(void)
{
	int rc = 0;
	pr_info("%s\n", __func__);
...
static struct msm_camera_sensor_info msm_camera_sensor_ov4688_data = {
	.sensor_name	= "ov4688",
	.camera_power_on = m7wlv_ov4688_vreg_on,
	.camera_power_off = m7wlv_ov4688_vreg_off,
	.camera_yushanii_probed = m7wlv_yushanii_probed,
	.pdata	= &m7wlv_msm_camera_csi_device_data[0],
...
struct i2c_board_info m7wlv_camera_i2c_boardinfo_ov4688_0x6c_ov2722[] = {
...
struct i2c_board_info m7wlv_camera_i2c_boardinfo_ov4688_0x20_ov2722[] = {
...
void __init m7wl_init_cam(void)
{
	...
	if ( (((engineerid&1)==0) && (system_rev < 2)) ||
		...
		if (main_camera_id == CAMERA_SENSOR_ID_ST_4M) {
			...
			if(1){
				i2c_register_board_info(APQ_8064_GSBI4_QUP_I2C_BUS_ID,
					m7wlv_camera_i2c_boardinfo_ov4688_0x20_ov2722,
					ARRAY_SIZE(m7wlv_camera_i2c_boardinfo_ov4688_0x20_ov2722));
			}else{
				i2c_register_board_info(APQ_8064_GSBI4_QUP_I2C_BUS_ID,
					m7wlv_camera_i2c_boardinfo_ov4688_0x6c_ov2722,
					ARRAY_SIZE(m7wlv_camera_i2c_boardinfo_ov4688_0x6c_ov2722));
			}
			update_yushanII_flag(HTC_CAMERA_IMAGE_YUSHANII_BOARD);
		}
		else {
